  ...
  return (
    <div>
      <section className='cf mt5 pv5 bt b--black-05 ph6-l'>
        ...
        <a href='https://forrestblade.github.io' className='fl w-third w-25-ns border-box overflow-hidden ba bw2 white' title>
          <div className='grow cover bg-center pv5 pv6-l' style={{ backgroundImage: `url(${rgb})` }} />
        </a>
