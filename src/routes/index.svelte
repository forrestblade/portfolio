    ...
    <div class="warning-content">
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <g id="large">
                ...
                C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#6b9362" />
        ...
        <ul class="list tc pl0 w-100 mt5">
          ...
          <li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/about.html">About</a></li>
          <li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/contact.html">Contact</a></li>
        </ul>
